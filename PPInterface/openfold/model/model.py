...
from PPInterface.openfold.model.embedders import (ExtraMSAEmbedder, InputEmbedder,
                                                  RecyclingEmbedder,
                                                  TemplateAngleEmbedder,
                                                  TemplatePairEmbedder)
from PPInterface.openfold.model.evoformer import EvoformerStack, ExtraMSAStack
from PPInterface.openfold.model.heads import AuxiliaryHeads
from PPInterface.openfold.model.structure_module import StructureModule
from PPInterface.openfold.model.template import (TemplatePairStack,
                                                 TemplatePointwiseAttention,
                                                 embed_templates_average,
                                                 embed_templates_offload)
from PPInterface.openfold.utils.feats import (atom14_to_atom37, build_extra_msa_feat,
                                              build_template_angle_feat,
                                              build_template_pair_feat,
                                              pseudo_beta_fn)
from PPInterface.openfold.utils.tensor_utils import add, tensor_tree_map
...
class AlphaFold(nn.Module):
    ...
    def forward(self, batch):
        ...
        #    print(self.aux_heads(cycle_output[i])["predicted_tm_score"])
